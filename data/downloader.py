...
logging.basicConfig(level=logging.INFO, format="%(ascitime)s | %(levelname)s | %(message)s", datefmt="%H:%M:%S")
...
def download_all(
    batch_size: int = 10,
    sleep_between_batches: float = 1.5,) -> Dict[str, Dict[str, Dict[str, pd.DataFrame]]]:
